  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Cetris</div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseHeader" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-fw fa-cog"></i>
          <span>Header</span>
        </a>
        <div id="collapseHeader" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Update Header section:</h6>
            <a class="collapse-item" href="header.html">Greetings</a>
            <a class="collapse-item" href="header.html">Title</a>
            <a class="collapse-item" href="header.html">description</a>
          </div>
        </div>
      </li>
            ...
            <div class="col-10 mx-auto">
                <form class="">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="" id="firstValue">
                      </div>
                      <div class="form-group">
                        <label for="description">description</label>
                        <textarea class="form-control " rows="3" type="text" placeholder="" id="description"></textarea>
                      </div>

                      <div class="form-group">
                        <label for="secondValue">Second Value</label>
                        <input class="form-control" type="text" placeholder="" id="secondValue">
                      </div>
                      <div class="form-group">
                        <label for="description">description</label>
                        <textarea class="form-control " rows="3" type="text" placeholder="" id="description"></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="" id="thirdValue">
                      </div>
                      <div class="form-group">
                        <label for="description">description</label>
                        <textarea class="form-control " rows="3" type="text" placeholder="" id="description"></textarea>
